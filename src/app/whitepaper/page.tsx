    ...
    <div className="container mx-auto px-4 py-8 max-w-3xl prose dark:prose-invert lg:prose-xl">
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc list-inside mb-4 space-y-1 pl-4">
          ...
          <li><strong>Efficiency and Sustainability:</strong> All interactions with the AI are designed to be token-optimized. I craft my prompts to be as efficient as possible, ensuring that users get the maximum educational value from every API call, extending the life of their free-tier usage.</li>
        </ul>
      </section>
