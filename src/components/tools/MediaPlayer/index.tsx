      ...
      <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[384px] h-[646px] flex flex-col bg-background/80 backdrop-blur-xl border border-border rounded-2xl overflow-hidden text-foreground">
        ...
        <div className="flex flex-col overflow-hidden">
          <Tabs defaultValue="player" className="flex flex-col overflow-hidden">
            ...
            <TabsContent value="player" className="overflow-y-auto">
                <Player />
            </TabsContent>
            <TabsContent value="queue" className="overflow-y-auto">
              <Queue
                setHandleImportQueue={setImportHandler}
                setHandleExportQueue={setExportHandler}
              />
            </TabsContent>
            <TabsContent value="library" className="overflow-y-auto">
              <Library />
            </TabsContent>
          </Tabs>
        </div>
