...
- NO NESTED/REPEATED DELIMITERS: Use exactly ONE pair of \`\\$...\\$\` for inline math or ONE pair of \`\\$\\$...\\$\\$\` for display math. NEVER output \`\\$\\$\\$...\$\$ \$\$\` or \`\\$\\$...\$\$\` or similar repeated/nested forms. This is invalid and will break rendering.
